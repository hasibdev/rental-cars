...
<template>
  <div class="mt-4">
    <DataTable :loading="loading" :data="countryData?.countrys || []" :fields="fields">
  ...
  <!-- Entfernen Modal -->
  <ConfirmDialog v-model="showDeleteModal" @onOk="onDelete" :okLoading="deleting" :title="t('countrySettings.delete-modal-title')" :message="t('countrySettings.delete-modal-text')"></ConfirmDialog>
</template>
