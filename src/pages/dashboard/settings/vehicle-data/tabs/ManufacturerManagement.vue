...
<template>
  <div class="mt-4">
    <DataTable :loading="loading" :data="manufacturerData || []" :fields="fields">
  ...
  <!-- Entfernen Modal -->
  <ConfirmDialog v-model="showDeleteModal" @onOk="onDelete" :okLoading="deleting" :title="t('manufacturerSettings.delete-modal-title')" :message="t('manufacturerSettings.delete-modal-text')"></ConfirmDialog>
</template>
