...
<template>
  <div class="mt-4">
    <DataTable :loading="loading" :data="fuelData || []" :fields="fields">
  ...
  <!-- Entfernen Modal -->
  <ConfirmDialog v-model="showDeleteModal" @onOk="onDelete" :okLoading="deleting" :title="t('fuelLevelSettings.delete-modal-title')" :message="t('fuelLevelSettings.delete-modal-text')"></ConfirmDialog>
</template>
