<script setup>
    ...
    const fetchData = async () =>{
        try {
            await api.get(`customer-confirm-decline/${route.params.id}`)
            sucessModalStatus.value = true;
            // const res = await api.get(`customer-confirm-reservation/${route.params.id}`)
    ...
    <ModalControl v-model="sucessModalStatus" @onHide="goToHome">
        <div class="modal-body">
            <div class="text-center">
                ...
                <p>{{t('text.your-reservation-is-declined')}}</p>
