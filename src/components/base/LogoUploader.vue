...
<template>
  <div class="py-4">
    <div class="">
      <img v-if="url || image" :src="url || image" alt="" class="img-fluid" style="max-height: 200px" />
    ...
    <!-- <label :style="cssVar" for="profileUpload" class="profile-uploader__btn">Upload Logo</label> -->
    <div class="logo-upload-div mt-2">
      <label class="btn-upload py-2 fw-500 p" :style="cssVar" for="profileUpload" >
        Upload Logo
        <input type="file" id="profileUpload" @input="$emit('update:modelValue', $event.target.files[0])" @change="onFileChange" name="upload-logo"  />
      </label>
    </div> 
  </div>
