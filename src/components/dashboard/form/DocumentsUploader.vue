  ...
  <div>
    ...
    <div class=" mt-3">
      ...
      <div v-for="(doc, i) in previousDocuments" :key="i" class="position-relative text-truncate pe-4">
        <a :href="doc.url" target="_blank" class=""><span class="text-muted">{{i+1}}.</span> {{ doc[prevTrack] }}</a>
      ...
      <div v-for="(doc, i) in previewDocuments" :key="i" class="position-relative text-truncate pe-4">
        <a :href="doc.url" target="_blank" class=""><span class="text-muted">{{i+1}}.</span> {{ doc.name }}</a>
